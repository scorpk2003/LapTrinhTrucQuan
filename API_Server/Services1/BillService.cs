...
namespace API_Server.src.Services1
{
    public class BillService
    {
                ...
                using (var context = new AppContextDB())
                {
                    using (var transaction = await context.Database.BeginTransactionAsync())
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            Console.WriteLine("Lỗi CreateBill (Inner): " + ex.Message);
            ...
            try
            {
                using (var context = new AppContextDB())
                {
                    ...
                    else
                    {
                        ...
                        // Update payment
                        context.Payments.Update(bill.Payment);
                    }
        ...
        public async Task<byte[]> ExportBillToPDFAsync(Guid billId)
        {
            // 1. Lấy dữ liệu
            ...
            try
            {
                ...
                byte[] pdfBytes = await Task.Run(() =>
                {
                    ...
                    .GeneratePdf(); // Trả về byte array thay vì lưu file
                });
