...
namespace QuanLyPhongTro.Migrations
{
    ...
    [Migration("20251115192714_AddBookingRequestTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.BillDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.BookingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Notice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Payment", b =>
                {
                    b.Property<Guid>("IdBill")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.PersonDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.RoomImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Bill", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Person", "IdPersonNavigation")
                        .WithMany("Bills")
                        .HasForeignKey("IdPerson")
                        .HasConstraintName("FK__Bill__IdPerson__5DCAEF64");

                    b.HasOne("QuanLyPhongTro.src.Test.Models.Room", "IdRoomNavigation")
                        .WithMany("Bills")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.BillDetail", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Bill", "IdBillNavigation")
                        .WithMany("BillDetails")
                        .HasForeignKey("IdBill")
                        .HasConstraintName("FK__BillDetai__IdBil__619B8048");

                    b.HasOne("QuanLyPhongTro.src.Test.Models.Service", "IdServiceNavigation")
                        .WithMany("BillDetails")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.BookingRequest", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Person", "Renter")
                        .WithMany()
                    ...
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Room", "Room")
                        .WithMany()
                        .HasForeignKey("IdRoom")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Contract", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Person", "IdRenterNavigation")
                        .WithMany("Contracts")
                        .HasForeignKey("IdRenter")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Expense", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Person", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Notice", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Report", "IdreportNavigation")
                        .WithOne("Notice")
                        .HasForeignKey("QuanLyPhongTro.src.Test.Models.Notice", "Idreport")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Payment", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Bill", "IdBillNavigation")
                        .WithOne("Payment")
                        .HasForeignKey("QuanLyPhongTro.src.Test.Models.Payment", "IdBill")
                        .IsRequired()
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Person", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.PersonDetail", "IdDetailNavigation")
                        .WithMany("People")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Report", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Person", "IdReporterNavigation")
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("QuanLyPhongTro.src.Test.Models.Room", b =>
                {
                    b.HasOne("QuanLyPhongTro.src.Test.Models.Person", "IdOwnerNavigation")
                        .WithMany("Rooms")
                        .HasForeignKey("IdOwner")
